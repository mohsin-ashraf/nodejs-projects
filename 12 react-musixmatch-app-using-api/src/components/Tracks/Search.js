...
class Search extends Component {
	...
	findTrack = (dispatch, e) => {
		e.preventDefault();
		axios.get(`https://cors-anywhere.herokuapp.com/http://api.musixmatch.com/ws/1.1/track.search?q_track=${this.state.trackTitle}&page_size=10&page=1^s_track_rating=desc&apikey=0fdfa3a539d1e428861e87180659e28c`)
			.then(res => {
